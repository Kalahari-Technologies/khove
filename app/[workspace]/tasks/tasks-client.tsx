  ...
  return (
    <div className="relative h-full w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6">
        <div className="w-14 h-14 rounded-2xl border border-white/[0.12] overflow-hidden bg-white/[0.05] flex items-center justify-center mb-6">
          <img src="/assets/khove.png" alt="Khove" className="w-full h-full object-cover select-none" draggable={false} />
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0 px-2">
                  <span
                    onClick={(e) => { e.stopPropagation(); router.push(`/${workspace.slug}/tasks/${task.id}`); }}
                    className={[
            ...
            <div className="flex-1 overflow-y-auto px-2 pb-2 flex flex-col gap-2">
              {colTasks.map(task => (
                <div
                  ...
                  onClick={() => router.push(`/${workspace.slug}/tasks/${task.id}`)}
    ...
    <div className="h-full flex flex-col bg-black">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-white/[0.07] flex-shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* View toggle — hidden for personal workspaces (table only) */}
          {!isPersonalWorkspace && (
      ...
      {/* Content */}
      {viewMode === "table" || isPersonalWorkspace ? (
        <>
