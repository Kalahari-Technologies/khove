          ...
          {!verifying ? (
            <>
              ...
              <BoxReveal duration={0.3} className="pb-2">
                <p className="text-[14px] text-white/50">Join Khove and start working smarter</p>
              </BoxReveal>
            ...
            <>
              <BoxReveal duration={0.3}>
                <h1 className="text-[28px] font-bold text-white">Verify your email</h1>
              </BoxReveal>

              <BoxReveal duration={0.3} className="pb-2">
                <p className="text-[14px] text-white/50">
                  We sent a code to <span className="text-white/80">{email}</span>
                </p>
              </BoxReveal>
