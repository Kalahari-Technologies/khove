...
import { CalendarClock, Clock, Link2, Users, Check, X, Ban, Sparkles } from "lucide-react";
  ...
  return (
    <div className={`rounded-xl border border-white/[0.08] bg-white/[0.02] ${compact ? "p-3" : "p-4"}`}>
      <div className="flex items-start gap-3">
        <div className="mt-0.5 w-7 h-7 rounded-lg bg-teal-400/10 border border-teal-400/20 flex items-center justify-center flex-shrink-0">
